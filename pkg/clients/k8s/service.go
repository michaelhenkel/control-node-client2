...
func handleService(service *corev1.Service, event api.Action, serviceImportChan chan api.ServiceCommunity, serviceExportChan chan api.ServiceCommunity, contrailClientSet *contrailClient.Clientset, kubernetesClientSet *kubernetes.Clientset) error {
